...
## Corpus Check
- 239 files · ~393,901 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3479 nodes · 6660 edges · 205 communities (195 shown, 10 thin omitted)
...
### Community 3 - "Src Llm"
Cohesion: 0.24
Nodes (5): find_rect(), FocusDir, PaneManager, remove_leaf(), Option
...
Cohesion: 0.20
Nodes (10): Metrics, Buffer, Device, FontSystem, Option, SwashCache, Vec, ShapedRun (+2 more)
...
Cohesion: 0.15
Nodes (18): AcpSession, build_acp_agent(), PromptMsg, AcpAgent, JoinHandle, McpServer, Path, Result (+10 more)
...
Cohesion: 0.11
Nodes (19): ApplicationHandler, App, ActiveEventLoop, Arc, Drop, EventLoopProxy, HashMap, InfoOverlay (+11 more)
...
Cohesion: 0.08
Nodes (27): brighten(), build_usage_hint(), calculate_row_hash(), colors_approx_eq(), GridVisualState, pack_color(), RenderContext, resolve_span_fg() (+19 more)

### Community 35 - "Src App"
Cohesion: 0.11
Nodes (14): resolve_line_fg(), RenderContext, ContextMenu, InfoOverlay, Option, StatusBar, Mux, ColorScheme (+6 more)
...
Cohesion: 0.12
Nodes (10): PaneForest, Default, Into, Option, Self, String, TabManager, Vec (+2 more)
...
Cohesion: 0.13
Nodes (14): FromStr, idx_or_default(), gpui_shell_actions(), Vec, Action, built_in_actions(), PaletteAction, FocusDir (+6 more)
...
Cohesion: 0.35
Nodes (11): closing_a_background_workspace_after_active_leaves_active_index_unchanged(), closing_a_background_workspace_before_active_keeps_the_same_workspace_active(), closing_an_unknown_workspace_id_is_refused(), closing_the_active_workspace_clamps_to_the_new_last_index(), closing_the_only_remaining_workspace_is_refused(), new_workspace_creates_and_activates_it(), next_and_prev_workspace_wrap_around(), rename_workspace_by_id_renames_a_non_active_workspace_and_leaves_active_alone() (+3 more)
...
Cohesion: 0.25
Nodes (6): AiEvent, ConfirmDisplay, PathBuf, Sender, String, Vec
...
Cohesion: 0.10
Nodes (7): Mux, Arc, FocusDir, HashMap, TabManager, VecDeque, WorkspaceData

### Community 131 - "render_line"
Cohesion: 0.15
Nodes (15): AttrsList, LruCache, build_attr_list(), CellStyle, has_ligature_chars(), is_pua(), Attrs, HashSet (+7 more)

### Community 132 - "Self"
Cohesion: 0.09
Nodes (26): BatterySaverMode, blur_translucency_only_when_translucent(), ChatUiConfig, Config, GpuPreference, KeybindStyle, KeyboardConfig, LeaderConfig (+18 more)
...
### Community 136 - "Pty"
Cohesion: 0.23
Nodes (16): adjust_parent_split(), collect_leaf_infos_impl(), collect_separators_impl(), contains_leaf(), drag_split_ratio(), next_node_id(), PaneInfo, PaneNode (+8 more)
...
Cohesion: 0.22
Nodes (16): FnMut, cell_in_selection(), drain_pty_events(), FlagHintOverlay, GhostOverlay, production_pty_drain_preserves_payload_and_special_events_across_budget(), PtyEventBatch, AnsiColor (+8 more)
...
### Community 149 - "Cell"
Cohesion: 0.21
Nodes (6): LcdCursorPatch, OverlayUploadPlan, production_cursor_builder_and_overlay_upload_state_are_connected(), RenderContext, RenderOverlayState, Option
...
- **Why does `Config` connect `Self` to `Src Config`, `Src App`, `Src Term`, `Src Renderer`, `.collect_grid_cells_for`, `spawn_terminal_at`, `Src App`, `Src Term`, `Src Config`, `Cell`, `Src App`, `spawn_acp_connect`, `Src Llm`, `Src Renderer`, `Src App`, `snippets.rs`, `Src Llm`, `Src App`, `UiManager`, `.dispatch_palette_action`, `keybind_view.rs`, `Src App`, `AcpAgentConfig`, `shaper.rs`, `Src Renderer`, `.rasterize_lcd_to_atlas`, `RenamePrompt`, `Mux`, `Config`, `build_font_system`?**
  _High betweenness centrality (0.292) - this node is a cross-community bridge._
- **Why does `ColorScheme` connect `Src App` to `Src Term`, `Self`, `to_rgba`, `sections.rs`, `Src Config`, `Cell`, `Benches Build Instances.rs`, `Src Ui`, `Src Renderer`, `Src App`, `Src App`, `Src Llm`, `RowRevisionMap`, `Src App`, `render_header`, `.dispatch_palette_action`, `WakeupGate`, `.rasterize_lcd_to_atlas`, `String`, `.handle_redraw`, `resolve_color`, `AppMenu`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `Terminal` connect `Src Term` to `gpu.rs`, `Src Term`, `snippets.rs`, `Src App`, `Src Term`, `Src App`, `Src App`, `ResizeHandleElement`, `Src Term`, `full_grid_text`, `Column`, `spawn_terminal_at`, `snapshot.rs`, `Benches Build Instances.rs`, `Src Llm`?**
