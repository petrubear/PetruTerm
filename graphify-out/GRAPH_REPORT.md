...
## Corpus Check
- 150 files · ~243,477 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2411 nodes · 4941 edges · 116 communities (109 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 69 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `aa213969`
...
Cohesion: 0.15
Nodes (23): AcpAgentConfig, BatterySaverMode, ChatUiConfig, Config, GpuPreference, KeyboardConfig, LeaderConfig, LlmBackend (+15 more)
...
Cohesion: 0.05
Nodes (63): AttrsList, bench_shape_line_ascii(), bench_shape_line_ascii_cached(), bench_shape_line_ligatures(), bench_shape_line_ligatures_cached(), bench_shape_line_unicode(), make_colors(), make_shaper() (+55 more)
...
Cohesion: 0.20
Nodes (17): Event, EventListener, Fn, OnceLock, RawFd, pty_write_all(), PtyEvent, PtyEventProxy (+9 more)
...
Cohesion: 0.08
Nodes (17): CursorShape, Dimensions, F, CursorInfo, process_cwd(), Arc, FairMutex, Option (+9 more)
...
### Community 28 - "Src Ui"
Cohesion: 0.12
Nodes (15): StatusBarColors, StatusBarConfig, StatusBarPosition, StatusBarStyle, format_time(), Default, Option, Path (+7 more)
...
Cohesion: 0.24
Nodes (4): ElementState, MouseButton, KeyEvent, Option
...
Cohesion: 0.11
Nodes (13): GridVisualState, RenderContext, RowCache, RowCacheEntry, Arc, Color, HashSet, Option (+5 more)
...
Cohesion: 0.16
Nodes (15): brighten(), build_usage_hint(), calculate_row_hash(), colors_approx_eq(), pack_color(), resolve_span_fg(), ChatPanel, HashMap (+7 more)
...
- **Why does `Config` connect `Src Config` to `Src App`, `Src Ui`, `Src App`, `Src Term`, `Src Renderer`, `Src Term`, `Src App`, `Src Config`, `Src App`, `Src Ui`, `Src App`, `Src App`, `Src App`, `Src App`, `AcpAgentConfig`, `shaper.rs`, `Src Renderer`, `.rasterize_lcd_to_atlas`, `keybind_view.rs`, `.handle_redraw`, `Mux`, `gpu.rs`, `CellVertex`?**
  _High betweenness centrality (0.380) - this node is a cross-community bridge._
- **Why does `FontConfig` connect `Src App` to `Src Config`, `.rasterize_lcd_to_atlas`, `Src Renderer`, `Src Font`, `Src Font`, `Src App`, `Src App`, `Src App`, `gpu.rs`, `Src App`, `Src App`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `ColorScheme` connect `Src App` to `Src Config`, `.rasterize_lcd_to_atlas`, `String`, `Src Term`, `Src App`, `Src Ui`, `Src App`, `gpu.rs`, `resolve_color`, `Benches Rasterize.rs`, `Src Config`, `CellVertex`, `Src Ui`?**
