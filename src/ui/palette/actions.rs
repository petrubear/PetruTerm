...
pub fn built_in_actions(config: &Config) -> Vec<PaletteAction> {
    ...
    let mut actions = vec![
        ...
        PaletteAction { name: "Focus Pane Left".into(),        action: Action::FocusPane(crate::ui::panes::FocusDir::Left),  keybind: kb("FocusPaneLeft") },
        PaletteAction { name: "Focus Pane Right".into(),       action: Action::FocusPane(crate::ui::panes::FocusDir::Right), keybind: kb("FocusPaneRight") },
        PaletteAction { name: "Focus Pane Up".into(),          action: Action::FocusPane(crate::ui::panes::FocusDir::Up),    keybind: kb("FocusPaneUp") },
        PaletteAction { name: "Focus Pane Down".into(),        action: Action::FocusPane(crate::ui::panes::FocusDir::Down),  keybind: kb("FocusPaneDown") },
